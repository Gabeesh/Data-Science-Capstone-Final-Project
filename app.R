...
ui <- fluidPage(
   ...
   sidebarLayout(
      sidebarPanel(
        h2("Instructions:"), 
        h5("1. Please enter word/s in the text box."),
        h5("2. The Prediction of next word prints below it in blue font."),
        h5("3. There is NO need to hit enter of submit."),
        ...
        br(),
          a("Source Code", href = "https://github.com/Gabeesh/Data-Science-Capstone-Final-Project")
      ),
